...
def upgrade() -> None:
    ...
    with op.batch_alter_table('animap_entry', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_animap_entry_provider_entry_id', ['provider', 'entry_id'], unique=False)
    ...
    with op.batch_alter_table('sync_history', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_sync_history_profile_library_media_outcome', ['profile_name', 'library_namespace', 'library_section_key', 'library_media_key', 'outcome'], unique=False)
        batch_op.create_index(batch_op.f('ix_sync_history_profile_name'), ['profile_name'], unique=False)
        batch_op.create_index('ix_sync_history_profile_timestamp', ['profile_name', 'timestamp'], unique=False)
